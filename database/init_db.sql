...
CREATE TABLE SALE (
    ...
    CONSTRAINT PK_SALE PRIMARY KEY(SALE_DAY_NUMBER, SALE_RECIPE_ID, SALE_PLAYER_NAME),
...
CREATE TABLE RECIPE_POSSESSION (
    ...
    RECIPE_POSSESSION_RECIPE_ID    INT             NOT NULL,

    CONSTRAINT PK_RECIPE_POSSESSION PRIMARY KEY(RECIPE_POSSESSION_PLAYER_NAME, RECIPE_POSSESSION_RECIPE_ID)
);
...
ALTER TABLE RECIPE_POSSESSION
ADD CONSTRAINT FK_RECIPE_POSSESSION_RECIPE_ID FOREIGN KEY (RECIPE_POSSESSION_RECIPE_ID) REFERENCES RECIPE (RECIPE_ID);
...
-- Mes item
INSERT INTO ITEM VALUES(0,'STAND',1,'Franck',3,2);
INSERT INTO ITEM VALUES(1,'AD',1,'Franck',5,2);
INSERT INTO ITEM VALUES(2,'AD',2,'Franck',4,2);
INSERT INTO ITEM VALUES(3,'AD',1,'Franck',3,3);
INSERT INTO ITEM VALUES(4,'STAND',2,'Martin',3,5);
INSERT INTO ITEM VALUES(5,'AD',1,'Martin',3,1);
...
INSERT INTO SALE VALUES(1,0,'Franck',5,5);
INSERT INTO SALE VALUES(1,1,'Franck',2,3);

INSERT INTO SALE VALUES(1,0,'Martin',2,5);
INSERT INTO SALE VALUES(1,1,'Martin',6,10);
